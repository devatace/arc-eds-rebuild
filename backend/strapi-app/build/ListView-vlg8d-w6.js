import{j as e,d as b,Z as p,eB as O,k as I,F as x,T as k,c as ye,f as R,aI as L,I as N,a as je,a5 as Ce,fR as we,bU as X,b6 as W,a2 as Y,fS as Te,b as Q,bA as $e,bH as ve,bI as ke,cK as De,bl as Me,o as ee,aF as Re,m as Fe,bJ as te,C as B,cZ as Ae,U as Ie,y as Se,eW as Ee,bn as Le,aO as J,fT as Oe,A as ne}from"./strapi-CGAa_rXE.js";import{u as D,g as m,C as _,a as V,A as Ue,S as Ne,c as K}from"./index-Cw0m3uXy.js";import{d as Be,e as Pe,D as Ze,f as ze,a as We,S as Ve,v as He,P as qe,c as Ge,C as Je}from"./sortable.esm-CIFxLjQf.js";import"./groupBy-_x7Ngucn.js";import"./_baseEach-DgzPyvvE.js";import"./sortBy-9xdXmzv-.js";import"./_baseMap-B5Vo6HDd.js";import"./index-CGh3H2bW.js";import"./index-BRVyLNfZ.js";const _e=t=>{let{transform:n}=t;return{...n,x:0}},Ke=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,ie=({component:t,isFromDynamicZone:n=!1,firstLoopComponentUid:o})=>{const{components:s}=D(),l=O(s,t);return e.jsx(oe,{$isChildOfDynamicZone:n,className:"component-row",children:e.jsx(de,{type:l,firstLoopComponentUid:o||t,isFromDynamicZone:n,isSub:!0,secondLoopComponentUid:o?t:null})})},et=({type:t,customField:n=null,repeatable:o=!1,multiple:s=!1})=>{const{formatMessage:l}=I();let a=t;return["integer","biginteger","float","decimal"].includes(t)?a="number":["string"].includes(t)&&(a="text"),n?l({id:m("attribute.customField"),defaultMessage:"Custom field"}):e.jsxs(e.Fragment,{children:[o&&l({id:m("component.repeatable"),defaultMessage:"Repeatable"}),s&&l({id:m("media.multiple"),defaultMessage:"Multiple"})," ",l({id:m(`attribute.${a}`),defaultMessage:t})]})},tt=({isActive:t=!1,icon:n="dashboard"})=>{const o=_[n]||_.dashboard;return e.jsx(x,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:e.jsx(o,{height:"2rem",width:"2rem"})})},se=b(p)`
  position: absolute;
  display: none;
  top: 5px;
  right: 0.8rem;
...
`,re=R.forwardRef((t,n)=>{const{style:o,...s}=t;return e.jsx(lt,{tag:"li",ref:n,...t.attributes,style:o,background:"neutral0",shadow:t.isOverlay?"filterShadow":"none","aria-label":t.item.name,children:e.jsx(dt,{...s})})}),dt=R.memo(t=>{const{item:n,firstLoopComponentUid:o,isFromDynamicZone:s,addComponentToDZ:l,secondLoopComponentUid:a,type:i,isDragging:c,isOverlay:f,handleRef:y,listeners:v}=t,r=f||c,[d,u]=R.useState(!0),w=i.status==="REMOVED",{contentTypes:T,removeAttribute:F,isInDevelopmentMode:M}=D(),{onOpenModalEditField:S,onOpenModalEditCustomField:A}=V(),{formatMessage:g}=I(),[h,j]=R.useState(!1),C=n.status==="REMOVED",P=n.type==="relation"&&n.relation.includes("morph"),ce=["integer","biginteger","float","decimal"].includes(n.type)?"number":n.type,E=n.type==="relation"?O(T,n.target):null,H=O(E,"plugin"),ue="target"in n&&n.target?"relation":ce,pe=$=>{$.stopPropagation(),K(T,n.name).length>0?j(!0):F({forTarget:i.modelType,targetUid:i.uid,attributeToRemoveName:n.name})},ge=()=>{F({forTarget:i.modelType,targetUid:i.uid,attributeToRemoveName:n.name}),j(!1)},me=()=>{j(!1)},q=()=>{if(!P&&n.configurable!==!1){const $=a||o||i.uid,Z=Qe(n.type),be=n.type==="component"?"2":null;n.customField?A({forTarget:i.modelType,targetUid:$,attributeName:n.name,attributeType:Z,customFieldUid:n.customField}):S({forTarget:i.modelType,targetUid:$,attributeName:n.name,attributeType:Z,step:be})}};let U;a&&o?U=2:o?U=1:U=0;const G=!w&&!C,fe=!w&&!C,he=w||C?"not-allowed":"move",xe=M&&n.configurable!==!1&&!P&&G;return e.jsxs(e.Fragment,{children:[e.jsxs(at,{$isOverlay:f,$isDragging:c,onClick:xe?q:void 0,paddingLeft:4,paddingRight:4,children:[e.jsxs(x,{alignItems:"center",overflow:"hidden",gap:2,children:[U!==0&&!f&&e.jsx(Ye,{color:s?"primary200":"neutral150"}),M&&e.jsx(N,{cursor:he,role:"Handle",ref:y,...v,variant:"ghost",withTooltip:!1,label:`${g({id:"app.utils.drag",defaultMessage:"Drag"})} ${n.name}`,disabled:w||C,children:e.jsx(je,{})}),e.jsxs(x,{gap:4,children:[e.jsxs(x,{gap:4,alignItems:"center",children:[e.jsx(Ue,{type:ue,customField:n.customField}),e.jsxs(k,{textColor:"neutral800",fontWeight:"bold",textDecoration:C?"line-through":"none",ellipsis:!0,overflow:"hidden",children:[n.name,"required"in n&&n.required&&e.jsx(k,{textColor:"danger600",children:"* "})]})]}),e.jsx(x,{children:e.jsxs(k,{textColor:"neutral600",children:[e.jsx(et,{type:n.type,customField:n.customField,repeatable:"repeatable"in n&&n.repeatable,multiple:"multiple"in n&&n.multiple}),"conditions"in n&&n.conditions&&Object.keys(n.conditions).length>0&&e.jsx(Ce,{margin:4,children:"conditional"}),n.type==="relation"&&e.jsxs(e.Fragment,{children:[" (",we(n.relation,n.targetAttribute),") ",E&&g({id:m("modelPage.attribute.with"),defaultMessage:"with"})," ",E&&e.jsx(X,{onClick:$=>$.stopPropagation(),tag:Y,to:`/plugins/content-type-builder/content-types/${E.uid}`,children:W(E.info.displayName)}),H&&`(${g({id:m("from"),defaultMessage:"from"})}: ${H})`]}),n.type==="component"&&e.jsx(ut,{uid:n.component})]})})]})]}),e.jsx(p,{children:e.jsx(x,{justifyContent:"flex-end",gap:1,onClick:$=>$.stopPropagation(),children:e.jsxs(e.Fragment,{children:[e.jsx(p,{children:n.status&&e.jsx(Ne,{status:n.status})}),["component","dynamiczone"].includes(n.type)&&e.jsx(N,{onClick:$=>{$.preventDefault(),$.stopPropagation(),u(!d)},"aria-expanded":d,label:g({id:"app.utils.toggle",defaultMessage:"Toggle"}),variant:"ghost",withTooltip:!1,children:e.jsx(Te,{"aria-hidden":!0,fill:"neutral500",style:{transform:`rotate(${d?"0deg":"-90deg"})`,transition:"transform 0.5s"}})}),M&&n.configurable!==!1?e.jsxs(e.Fragment,{children:[!P&&e.jsx(N,{onClick:q,label:`${g({id:"app.utils.edit",defaultMessage:"Edit"})} ${n.name}`,variant:"ghost",disabled:!G,children:e.jsx(Q,{})}),e.jsx(N,{onClick:pe,label:`${g({id:"global.delete",defaultMessage:"Delete"})} ${n.name}`,variant:"ghost",disabled:!fe,children:e.jsx($e,{})}),e.jsx(ve.Root,{open:h,onOpenChange:j,children:e.jsx(ke,{onConfirm:ge,onCancel:me,children:e.jsx(p,{children:e.jsxs(k,{children:[g({id:m("popUpWarning.bodyMessage.delete-attribute-with-conditions"),defaultMessage:"The following fields have conditions that depend on this field: "}),e.jsx(k,{fontWeight:"bold",children:K(T,n.name).map(({attribute:$})=>$).join(", ")}),g({id:m("popUpWarning.bodyMessage.delete-attribute-with-conditions-end"),defaultMessage:". Are you sure you want to delete it?"})]})})})})]}):e.jsx(x,{padding:2,children:e.jsx(De,{fill:"neutral500"})})]})})})]}),e.jsxs(ct,{$shouldHideNestedInfos:r,$isOpen:d,children:[n.type==="component"&&e.jsx(ie,{...n,isFromDynamicZone:s,firstLoopComponentUid:o}),n.type==="dynamiczone"&&e.jsx(rt,{...n,disabled:w||n.status==="REMOVED",addComponent:l,forTarget:i.modelType,targetUid:i.uid})]})]})}),ct=b(p)`
...
`,ut=({uid:t})=>{const{components:n}=D(),o=O(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(X,{onClick:s=>s.stopPropagation(),tag:Y,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:W(o.info.displayName)}),")"]})},ae=b(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
